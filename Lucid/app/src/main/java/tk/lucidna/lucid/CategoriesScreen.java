...
public class CategoriesScreen extends ActionBarActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
    ...
    public class PagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = {"Top Stories", "Business", "Politics", "Technology", "International", "Local"};
